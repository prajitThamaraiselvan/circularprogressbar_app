...
import 'package:purchased_pots/constants.dart';
...
class _ChitpotName_PageState extends State<ChitpotName_Page> {
  ...
  void _decrementContribution() {
    setState(() {
      contribution_amount = max(contribution_amount - 50, 0); // Ensure the amount doesn't go below 0
      _contributionController.text = contribution_amount.toString();
    });
  }
  ...
  void _showWithdrawBottomSheet() {
    if (_currentSliderValue > 6) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'For withdraw, the number of due should be greater than 6.'),
        ...
        children: [
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              icon: Image.asset('assets/exit_icon.png'),
            ),
          ),
          Positioned(
            top: 25,
                      ...
                      Container(
                        ...
                        child: SliderTheme(
                          data: SliderThemeData(
                            ...
                            activeTrackColor: Color.fromARGB(255, 13, 27,
                                139), // Visible color for active track
                            inactiveTrackColor: Color(
                                0xffD9D9D9), // Visible color for inactive track
                            trackHeight: 15,
                            thumbShape:
                          ...
                          child: Slider(
                            ...
                            min: 0,
                            max: 30, // Ensure this matches the maximum value
                            divisions: 30, // Number of discrete divisions
                            onChanged: (value) {
                              setState(() {
